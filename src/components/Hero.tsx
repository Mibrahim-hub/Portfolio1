      ...
      <div className="mx-auto grid w-full max-w-7xl gap-12 px-5 sm:px-8 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
        ...
        >
          <div className="relative mx-auto w-[220px] sm:w-[280px] lg:w-[340px]">
            {/* outer ambient glow */}
            <div className="absolute -inset-6 rounded-full bg-gradient-to-br from-primary-500/40 to-accent-500/40 blur-3xl" />
            {/* spinning ring */}
            <motion.div
              animate={{ rotate: 360 }}
              transition={{ repeat: Infinity, duration: 12, ease: 'linear' }}
              className="absolute -inset-1.5 rounded-full bg-gradient-to-tr from-primary-500 via-accent-400 to-primary-600 opacity-80"
